...
<body>
    ...
    <form action="ServletCaja" method="Post">
            <div class="input-group input-group-lg" id="numecuenta" placeholder="No.">
                <input type="number" id="input" name="id_saldo" placeholder="Número de Cuenta" required pattern="(^[0-9]{1,3}$|^[0-9]{1,3})">
            </div>     
            <div class="input-group input-group-lg">
              ...
              <input class="bton" type="submit" name="accion" value="Añadir saldo">
    </form>
  </div>
