    ...
    <body>
        ...
        <div class="container mt-4 mb-4 align-items-center justify-content-center">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <td scope="col" class="text-center"><strong>Producto</strong></td>
        ...
        session.setAttribute("id",detalle.getId_comida());
                ...
                <tbody>
                    <tr>
                        ...
                        <form action="SvUsuarios?accion=guardar" method="Post">

                    <td class="text-center">                

                    <input type="hidden" name="id" value="<%=detalle.getId_comida()%>" pattern="(^[0-9]{1,3}$|^[0-9]{1,3}\.[0-9]{1,3}$)">
                      <input class="form-control quantity-input" type="number" value="<%=detalle.getCantidad()%>" min="1" max="5" name="cantidad"></td>
                      <td class="text-center"><button class="btn btn-primary" type="submit" name="accion" value="guardar">guardar</button>
                                    </form>
</td>
                    
                
                <form action="SvUsuarios?accion=eliminar" method="Post">
                    <input type="hidden" name="id" value="<%=detalle.getId_comida()%>">
                    <td class="text-center">  <button type="submit" class="btn btn-danger btn-sm" name="accion"> Eliminar</button></td>
                </form>            
