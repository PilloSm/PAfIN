    ...
    <div class="cardd">
        ...
        <div class="buy">
            <div class="precio">
                ...
                <span><sup>$</sup><%=com.getPrecio()%></span>
            ...
            <div class="bton">
                ...
                <form action="SvUsuarios" method="post">
                    <input type="hidden" name="id" value="<%=com.getId()%>" id="hidden">
                    <label for="numero" id="hidden">Eliga la cantidad:</label>
                    ...
                    <input type="submit" name="accion" value="Agregar producto" id="boton">
                </form>
            </div>  
        </div>
        </div>
