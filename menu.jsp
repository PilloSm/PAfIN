  ...
  function enviarFormulario(idComida) {
    ...
    form.submit();
                                ...
                                <img src="<%=com.getImg()%>" class="card-img-top"
                                    alt="Imagen del alimento0">
                            
                            <div class="card-body">
                                <h5 class="card-title"><%=com.getNombre()%></h5>
                                <p class="card-text"><%=com.getPrecio()%></p>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><%=com.getNombre()%></h5>
                                <p class="card-text"><sup>$ </sup><%=com.getPrecio()%></p>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="caard">
                        ...
                        <div class="caard-body">
                            <h5 class="card-title"><%=come.getNombre()%></h5>
                            <p class="caard-text">Entradaa</p>
                            <p class="caard-text">Incluye refill de agua</p>
                            <p class="caard-text">No se vende por separado</p>
                            <p class="caard-text"><%=come.getPrecio()%></p>>
                        </div>
