...
<body>
    ...
    <div class="container d-flex flex-column align-items-center justify-content-center" style="height: 100vh">
        ...
        <form class="form_main p-3 bg-light text-left d-flex mx-auto rounded" id="fondo" action="ServletRegistro" method="Post">
            ...
            <div class="inputContainer text-center">
                <input placeholder="Usuario" id="user" class="inputField form-control mb-3" type="text"
                    ...
                    title="Ingrese un nombre de usuario válido (solo letras)" required>
            </div>
            <div class="inputContainer text-center">
                ...
                <input placeholder="Correo Electrónico" id="correo" class="inputField form-control mb-3" type="text"
            ...
            <div class="inputContainer text-center">
                ...
                <input placeholder="Contraseña" id="password" class="inputField form-control mb-3" type="password" name="contra"
                      pattern="[a-zA-Z0-9%&]+.{8,}" title="La contraseña debe tener al menos 8 caracteres" required>
            </div>
            <input type="submit" id="button" class="btn btn-primary mb-3" name="accion" value="Registro">
            <div class="signupContainer mt-4">
                <p>¿Ya tienes cuenta?</p>
                <a class="mb-4" href="./inicio.jsp">Inicia Sesión</a>
            </div>
        </form>
    </div>
    <footer class=" py-4">
